...
import static com.duydoanx.film.constants.ApplicationConstants.*;
...
public class VideoStreamService {
    ...
    public VideoStreamService(EpisodeRepository episodeRepository) {
     ...
     */
    public ResponseEntity<byte[]> prepareContent(int episodeId, String range) {
        long rangeStart = 0;
        long rangeEnd;
        byte[] data;
        Long fileSize;
        ...
        if (episodeOptional.isPresent()) {
            ...
            throw new RuntimeException("Can't find this episode!");
        }

        String fullFileName = episode.getLink();
        try {
        ...
        return ResponseEntity.status(HttpStatus.PARTIAL_CONTENT)
                .header(CONTENT_TYPE, VIDEO_CONTENT+ VIDEO_TYPE.MP4)
